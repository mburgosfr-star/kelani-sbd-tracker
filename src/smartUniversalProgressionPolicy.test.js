...
test('beginner Squat stimulus progresses beyond C1W11 even when C1W15 has another set count', () => {
  const lift = 'Squat';
  ...
  expect(
    (finalWarmups.length + completedSets.length) % 4
  ).toBe(0);
});
...
test('beginner Deadlift stimulus progresses beyond C1W9 at C1W14', () => {
  const lift = 'Deadlift';
